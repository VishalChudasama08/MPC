...
const Navbar = (props) => { // props argument is react props 
    return (
        <nav className={`navbar navbar-expand-lg navbar-${props.modeProp === 'light' ? 'light' : 'dark rounded border border-1'}`} style={{ backgroundColor: props.modeProp === 'light' ? '' : '#41464b' }}>
