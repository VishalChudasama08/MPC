        ...
        <div>
            ...
            <form>
                <div className="mb-3">
                    ...
                    <input type="text" name='title' onChange={onChange} className="form-control" id="title" placeholder="what is note title ?" />
                </div>
                <div className="mb-3">
                    <label htmlFor="description" className="form-label">Enter New Note</label>
                    <textarea name='description' onChange={onChange} className="form-control" id="description" placeholder='what is note description ?' rows="3"></textarea>
                </div>
                <div className="mb-3">
