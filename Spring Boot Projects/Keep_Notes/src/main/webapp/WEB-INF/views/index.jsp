...
<div class="row">
   ...
   <a id="loginButtonIndex" href="/login" class="col-2 btn btn-primary me-2">Login</a>
   <a id="registerButtonIndex" href="/register" class="col-2 btn btn-primary">Create A New Account</a>
   <span class="col-4"></span>
</div>
<script>
