<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
							...
							<li><strong>View Resolution:</strong>
								<ul>
									<li><code>"index"</code> string ને resolve કરવા માટે <code>prefix</code>
										અને <code>suffix</code> values ની મદદથી path generate થાય છે:
										<code>/WEB-INF/views/index.jsp</code>.
									</li>
								</ul>
							</li>
						</ul>
		...
		<h2>તેવીજ રીતે Get method showing this "/index" ત્યારે અથવા આ
			ફાઈલે માં આપેલી (નીચે છે તે) lick પર ક્લિક થાય ત્યારની પ્રોસેસ</h2>
		<p>
			In your <code>hello.jsp</code> file, you might have a link like this:
			<span
		...
		<p style="font-size: 20px;"><b> Steps how to create Spring First WEB-MVC Program :- </b></p>
		<br>
		<dl>
			<dd>1. Create MAVEN project (D:\Happy_Coding\Videos_lecture\Java create_servlet_project_with_maven.mp4 see
				this video for more details)</dd>
			<dd>2. Provide <i>"spring-webmvc"</i> dependency in pom.xml file</dd>
			<br>
			<dd>3. Configure <i>"DispatcherServlet"</i> class in web.xml file (present in src/main/webapp/WEB-INF/
				folder) OR in java class file (create in src/main/java folder)
				<dl>
					<dd>-- in this program i add `servlet` and `servlet-mapping` tag in web.xml file</dd>
				</dl>
			</dd>
			<dd>4. Create <i>"Spring Configuration File"</i> (create myds-servlet.xml in WEB-INF folder and 'the context
				schema')</dd>
			<br>
		...
		<img style="width: 100%; border: 3px solid red;" src="spring_web-mvc_structure_img.png"
			alt="Spring WEB-MVC Structure Image" />
<img style="width: 100%; border: 3px solid red;" src="images/spring_web-mvc_structure_img.png"
     alt="Spring WEB-MVC Structure Image" />
	</body>
