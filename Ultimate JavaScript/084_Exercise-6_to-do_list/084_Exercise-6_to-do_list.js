submit.addEventListener("click", (e) => { // submit is submit button id
    ...
    let titlec = title.value; // title is "To-Do List" input tag id
    let descc = desc.value; // desc is "ToDo Desc" input tag id
    ...
    title.value = ""; // after submit clear input bot
    desc.value = ""; // after submit clear input bot
})
