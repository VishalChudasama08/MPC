...
public class UserController {
	...
	public Map<String, String> getOneUser(@RequestBody Users user, HttpSession session) {
		...
		if (validUser != null) {
			...
			response.put("UserFirstName", validUser.getFirstName());
			response.put("UserLastName", validUser.getLastName());
			response.put("UserEmail", validUser.getEmail());
			response.put("UserPhoneNumber", validUser.getPhoneNumber());
